/**
 * Created by bridgeit on 16/12/16.
 */
/**
 * Satellizer 0.15.5
    ...
    var Local = (function () {
        ...
        Local.prototype.login = function (user, options) {
            ...
            return this.$http(options).then(function (response) {
                // console.log(response.headers()['x-ekincare-key']);
                _this.SatellizerShared.setToken({access_token:response.headers()['x-ekincare-key']});
                return response;
            });
        };
